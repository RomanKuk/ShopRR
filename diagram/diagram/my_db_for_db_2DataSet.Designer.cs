...
namespace diagram {
    ...
    public partial class my_db_for_db_2DataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/my_db_for_db_2DataSet.xsd";
        ...
        public partial class AddressDataTable : global::System.Data.TypedTableBase<AddressRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public AddressRow AddAddressRow(string Name, int City_ID) {
...
namespace diagram.my_db_for_db_2DataSetTableAdapters {
    ...
    public partial class AddressTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Address] WHERE (([Address_ID] = @Original_Address_ID) AND ([Na" +
                "me] = @Original_Name) AND ([City_ID] = @Original_City_ID))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Address] ([Name], [City_ID]) VALUES (@Name, @City_ID);\r\nSELECT" +
                " Address_ID, Name, City_ID FROM Address WHERE (Address_ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Address] SET [Name] = @Name, [City_ID] = @City_ID WHERE (([Address_ID] = @Original_Address_ID) AND ([Name] = @Original_Name) AND ([City_ID] = @Original_City_ID));
SELECT Address_ID, Name, City_ID FROM Address WHERE (Address_ID = @Address_ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Address_ID, Name, City_ID FROM dbo.Address";
        ...
        public virtual int Fill(my_db_for_db_2DataSet.AddressDataTable dataTable) {
        ...
        public virtual my_db_for_db_2DataSet.AddressDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            my_db_for_db_2DataSet.AddressDataTable dataTable = new my_db_for_db_2DataSet.AddressDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(my_db_for_db_2DataSet.AddressDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Address_ID, string Original_Name, int Original_City_ID) {
        ...
        public virtual int Insert(string Name, int City_ID) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, int City_ID, int Original_Address_ID, string Original_Name, int Original_City_ID, int Address_ID) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, int City_ID, int Original_Address_ID, string Original_Name, int Original_City_ID) {
            return this.Update(Name, City_ID, Original_Address_ID, Original_Name, Original_City_ID, Original_Address_ID);
        }
    }
